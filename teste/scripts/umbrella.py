...
class Umbrella:
    ...
    def update(self,playerPos):
        ...
        dynamic_speed = "math.cos("+str(self.get_angle(True))+"+ ((random.random()-0.5)*(math.pi/2)))*6,-math.sin("+str(self.get_angle(True))+"+ ((random.random()-0.5)*(math.pi/2)))*6"
    ...
    def shot(self):
        if len(self.projectiles) == 0:
            ...
            #for i in range(5):
                #rand_angle = self.angle + ((random.random()-0.5)*(math.pi/6))
